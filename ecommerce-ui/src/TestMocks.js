export const MOCK_TITLE = "The Best Place!!";
export const MOCK_HOUSETYPE="Apartment";
export const MOCK_IMAGE = "https://via.placeholder.com/350";
export const MOCK_COST = 16;
export const MOCK_STARS = 4;
export const MOCK_REVIEWS = 122;
export const MOCK_IS_SUPERHOST = true;

export const MOCK_RENTAL_1 =   {
